...
namespace GameAi.ZombieStates
{
    ...
    public class ZombieStateMachine : StateMachine
    {
        ...
        private PlayerInView _lastKnownPlayerPosition;
        ...
        {
            return GetPathTo(_lastKnownPlayerPosition.PlayerTransform.position, onPathComplete);
        }
