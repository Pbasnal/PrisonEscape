...
#pragma warning restore 0618
        ...
        protected bool SetState(GestureRecognizerState value)
        {
            ...
            else if (!CanExecuteGestureWithOtherGesturesOrFail(value))
            {
                ...
                && RequiredGesturesToFailAllowsEndPending())
            {
        ...
        {
            // this gesture should be enabled
            // parameter touches should contain some value and touches should intersect with 
            // touches that are getting tracked for them to be moved.
    ...
    public static class GestureLogger
    {
        ...
        public static void Log(this DigitalRubyShared.GestureRecognizer gesture, string text, params object[] args)
        {
            ...
            UnityEngine.Debug.LogFormat(DateTime.UtcNow + " (" + gesture.NameOfGesture + "): " + text, args);
